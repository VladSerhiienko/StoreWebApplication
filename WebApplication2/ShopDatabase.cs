...
namespace StoreWebApplication
{
  ...
  public class StoreDatabase
  {
    ...
    public static string HtmlSectionDesc(HttpRequest request, int sectionIndex)
    {
    ...
    public static string HtmlSectionContainerDesc(HttpRequest request, int sectionIndex)
    {
    ...
    public static string CompileToHtml(HttpRequest request)
    {
